...
CREATE TABLE `worklog` (
  ...
  PRIMARY KEY (`emp_id`),
  CONSTRAINT `worklog_ibfk_1` FOREIGN KEY (`emp_id`) REFERENCES `employee` (`emp_id`) ON UPDATE CASCADE
...
INSERT INTO `worklog` VALUES ('E0001','2018-10-11','2018-10-11 00:00:00','2018-10-11 09:59:59');
